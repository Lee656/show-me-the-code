...
def generate_captcha(size):
    ...
    for idx, ch in enumerate(captcha):
        pos = (20+idx*width/4, height/4)
...
if __name__ == "__main__":
    try:
        captcha_img = generate_captcha(size=(300,100))
        captcha_img.show()
    except Exception, e:
        print e